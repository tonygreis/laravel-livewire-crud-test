<div>
    <div class="container mx-auto px-4 sm:px-8">
        <div class="flex">
            <a class="bg-blue-300 p-2 font-bold rounded-lg mt-2" href="{{ route('fields.create') }}">Create</a>
        </div>
        <div class="py-2">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Fields</h2>
            </div>
                        ...
                        @foreach($fields as $field)
                            <tr>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap"><a href="{{ route('fields.show', $field) }}" class="font-bold text-blue-300">{{ $field->name }}</a> </p>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <a href="{{ route('fields.edit', $field) }}" class="text-blue-400 font-bold">Edit</a>
